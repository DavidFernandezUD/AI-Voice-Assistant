...
class WakewordRecognizer:
    ...
    def predict(self, path: str):
        ...
        spec = self.featurizer(audio, sample_rate).unsqueeze(dim=0)
...
if __name__ == "__main__":
    ...
    recorder = WakewordRecognizer("models/wakeword_model_16KH.pth", sample_rate=48000, channels=1, input_device=7)
